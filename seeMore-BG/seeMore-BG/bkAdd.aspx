...
<script runat="server">
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        int z = 1;
        int q = 1;
        string savePath = "C:\\恆毅課程\\seeMore-BG\\seeMore-BG\\Upload\\";
        string savePath2 = "C:\\恆毅課程\\seeMore\\seeMore\\Upload\\";
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-3 mb-2">
                                    <asp:Button ID="Button2" runat="server" Text="DEMO" class="btn mb-1 btn-danger btn-lg" OnClick="Button1_Click"  OnClientClick="return false"/>
    ...
    <script>
        $(function() {
            $("#mycontent_Button2").click(function() {
                $("#mycontent_TextBox1").val("KAOHSIUNG");
                $("#mycontent_TextBox2").val("HotelKingdom");
                $("#mycontent_TextBox3").val("華王大飯店");
                $("#mycontent_TextBox4").val("基地面積");
                $("#mycontent_TextBox5").val("建築面積");
                $("#mycontent_TextBox6").val("總樓地板");
                $("#mycontent_TextBox7").val("VIST");
                $("#mycontent_TextBox8").val("1,415㎡");
                $("#mycontent_TextBox9").val("1,140㎡");
                $("#mycontent_TextBox10").val("15,572㎡");
                $("#mycontent_TextBox11").val("http://www.hotelkingdom.com.tw");
                $("#mycontent_TextBox12").val("華王大飯店，是老中青三代高雄人的共同回憶");
                $("#mycontent_TextBox13").val("姚德雄聯合設計有幸經手二次華王大飯店的裝修改造，我們的服務包含旅館大廳、商務中心、前台、七至十一層客房共計158間，含室內裝修設計、生財設計及協調、整合專案管理。飯店五十載老店新開，姚德雄設計也跟著一同經歷時光淬煉成長。");
                $("#mycontent_TextBox14").val("華王大飯店，是老中青三代高雄人的共同回憶，姚德雄聯合設計有幸經手二次華王大飯店的裝修改造，我們的服務包含旅館大廳、商務中心、前台、七至十一層客房共計158間，含室內裝修設計、生財設計及協調、整合專案管理。飯店五十載老店新開，姚德雄設計也跟著一同經歷時光淬煉成長。");

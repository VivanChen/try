...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            Medium p = mediaUtility.GetAllMediumById1(id1);

            TextBox1.Text = p.mediaText1;
            
            Image1.ImageUrl = $"~/Frontdesk/images/realimg/媒體/{p.mediaImage}";
            ProjectIdLabel1.Text = p.MediaId.ToString();

            HiddenField1.Value = p.MediaId.ToString();
            HiddenField2.Value = p.mediaImage;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string savePath = "C:\\恆毅課程\\seeMore-BG\\seeMore-BG\\Frontdesk\\images\\realimg\\媒體\\";
        string savePath2 = "C:\\恆毅課程\\seeMore\\seeMore\\Frontdesk\\images\\realimg\\媒體\\";
        int total = 0;
        if (FileUpload1.HasFile)
        {
            ...
            Medium p = new Medium()
            {
                MediaId = int.Parse(HiddenField1.Value),
                mediaText1 = TextBox1.Text,                
                mediaImage = TextBox1.Text + q +".jpg",


            };

            mediaUtility.UpdateMedium(p);
            Response.Redirect("~/bkMediaList.aspx");
        }
        else
        {
    ...
    <div class="content-body">
        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">出版作品</a></li>

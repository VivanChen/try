    ...
    <form id="form1" runat="server">
                                ...
                                <div method="post" class="form-outline-style-v1" id="contactForm">
                                    ...
                                    <div class="form-group row gsap-reveal">
                                        <div class="col-md-12 d-flex align-items-center">
                                            ...
                                            <asp:Button ID="Button1" runat="server" Text="Send Message" class="btn btn-outline-pill btn-custom-light mr-3" OnClick="Button1_Click" />
                                            <asp:Button ID="Button2" runat="server" Text="DEMO" class="btn btn-outline-pill btn-custom-light mr-3" OnClientClick="return false" />
        ...
        $(function() {
            $("#Button2").click(function() {
                $("#TextBox1").val("陳韋安");
                $("#TextBox2").val("jay@gmail.com");
                $("#TextBox3").val("我看了你們公司網站對你們很有興趣，請問可以約時間去貴公司拜訪嗎?");

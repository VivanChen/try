...
<body>
    <form id="form1" runat="server">
        ...
        標題<asp:TextBox ID="Message_Header" runat="server" required="" aria-required="true" oninput="setCustomValidity('');" oninvalid="setCustomValidity('記得填寫標題ㄛ')" ></asp:TextBox>
        <p>
            暱稱<asp:TextBox ID="Message_Name" runat="server"></asp:TextBox>
        </p>
        內容
        <asp:TextBox ID="Message_Main" runat="server" Height="477px" TextMode="MultiLine" Width="596px"></asp:TextBox>
        <br />
        <br />
        <br />
        <p>
